              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Explore college options</p>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-muted rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Start first course</p>
